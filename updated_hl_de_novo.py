...
# 
# The AC and AN values used here can be generated by my sex-aware variant annotation function from the other_functions.py file
# See also https://discuss.hail.is/t/de-novo-calls-on-hemizygous-x-variants/2357/19
...
def updated_hl_de_novo(mt: MatrixTable,
            pedigree: Pedigree,
            pop_frequency_prior,
            *,
            min_gq: int = 20,
